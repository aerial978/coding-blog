...
final class Email2faServiceProvider
{
    /**
    ...
    {
        return [
            Email2faPendingSession::class => static function (
            ...
            Email2faPendingSessionInterface::class => static function (
                ...
                $pendingSession = $container->get(
                    Email2faPendingSession::class
                );

                return $pendingSession;
            },

            Email2faService::class => static function (
                ContainerInterface $container
            ): Email2faService {
                /** @var Email2faChallengeModelInterface $challengeModel */
                $challengeModel = $container->get(
                    Email2faChallengeModelInterface::class
                );
